...
void chatting::socket::connect(const std::string& ip, unsigned short int port)
{
    ...
    int connect_status = ::connect(m_socket_fd, (struct sockaddr*)&serv_addr, sizeof(serv_addr));
    if (connect_status == -1) {
